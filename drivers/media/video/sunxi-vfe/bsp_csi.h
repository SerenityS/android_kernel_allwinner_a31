...
extern void inline bsp_csi_int_get_status(unsigned int sel, unsigned int ch,struct csi_int_status *status);
extern void inline bsp_csi_int_clear_status(unsigned int sel, unsigned int ch, enum csi_int_sel interrupt);
