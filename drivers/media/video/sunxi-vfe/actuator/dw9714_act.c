...
#define ACT_DEV_DBG_EN 1

//print when error happens
#define act_dev_err(x,arg...) printk(KERN_ERR"[ACT_ERR][dw9714_act]"x,##arg)

//print unconditional, for important info
#if ACT_DEV_DBG_EN == 1
#define act_dev_dbg(x,arg...) printk(KERN_INFO"[ACT][dw9714_act]"x,##arg)
#else
