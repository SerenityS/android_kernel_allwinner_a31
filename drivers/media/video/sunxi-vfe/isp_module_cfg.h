...
#define ISP_GAMMA_TBL_SIZE          256 //1.41
...
struct isp_sharp_config
{
  ...
  unsigned char sharp_min_val;
  unsigned char sharp_max_val;
};
...
struct isp_afs_config
{
   unsigned int inc_line;        /* 该值改变时，需要改变相应寄存器 */ 
};
