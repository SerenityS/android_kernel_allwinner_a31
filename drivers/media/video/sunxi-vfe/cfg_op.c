...
/*
 * name:    strim_char
 * func:    trim a specific charator 
 *          at front and end of a string 
 ...
 * input£º  char *buffer, int maxlen,
 * output£º char *line_buf
 * return£º the actual length of buffer which has been read          
 */
 ...
 * input£º  char *buffer, void *section,void *key
 * output£º void *value
 * return£º error number          
 */
 ...
 * input£º  char *buffer, void *section
 * output£º char *keys[],void *value[]
 * return£º if correct, return keys number
 ...
 * input£º  struct file *buffer 
 * output£º char *sections[]
 * return£º number of sections or error number (negative)  
 */
 ...
 * input£º  char *buffer, struct cfg_mainkey *scts
 * output£º struct cfg_subkey *subkey
 * return£º error number
 */
 ...
 * input£º  char *buffer, struct cfg_mainkey *scts
 * output£º struct cfg_mainkey *scts
 * return£º error number
 */
 ...
 * input£º  struct cfg_subkey **subkey
 * output£º 
 * return£º error number
 */
 ...
 * input£º  struct cfg_mainkey **mainkey
 * output£º 
 * return£º error number
 */
 ...
 * input£º  struct cfg_section **cfg_sct
 * output£º 
 * return£º error number
 */
 ...
 * input£º  char *file_path,size_t len
 * output£º char *buf
 * return£º the actual length has been read
 */
 ...
 * input£º  char *file_path
 * output£º struct cfg_section **cfg_section
 * return£º error number
 */
 ...
 * input£º  struct cfg_section *cfg_section, char *main, char *sub
 * output£º struct cfg_subkey *subkey
 * return£º error number
 */
