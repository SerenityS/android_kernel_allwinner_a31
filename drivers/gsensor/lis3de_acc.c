...
int lis3de_acc_input_open(struct input_dev *input)
{
...
void lis3de_acc_input_close(struct input_dev *dev)
{
...
static int __devexit lis3de_acc_remove(struct i2c_client *client)
{
